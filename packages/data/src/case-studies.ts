...
export const flytBaseCaseStudyKnowledgeBase = [
  ...
  },
  {
    ...
    title: "SQM - Autonomous Mining Inspections",
    industry: "Mining",
    useCases: [
    ...
    proofPoints: [
      ...
      "Enables defined autonomous inspection zones for repeatable monitoring.",
    ...
    searchText:
      "SQM mining mine site autonomous inspections inspection zones industrial remote monitoring operational risk visibility harsh site conditions hazardous environment large mine autonomous drone inspection.",
  },
  {
